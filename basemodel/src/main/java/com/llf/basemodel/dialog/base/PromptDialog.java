package com.llf.basemodel.dialog.base;
...
/**
 * 1.提示
 * new PromptDialog.Builder(MainActivity.this).hintShow("我试试");
 * 2.dialog 按钮
 * new PromptDialog.Builder(MainActivity.this).setMessage("确认删除么!").setTitle("提示")
...
public class PromptDialog extends Dialog {
    ...
    public static class Builder {
        ...
        private void initData() {
            this.button1TextColor = Color.parseColor("#4697FB");
        ...
        public PromptDialog create() {
            ...
            switch (btnCountFlag) {
                ...
                case 5:
                    ...
                    btnCenter
                            .setBackgroundResource(R.drawable.fynn_prompt_dialog_btn_single_normal);
                    if (button1Text != null) {
                ...
                case 3:
                    ...
                    msgBtnDivider.setVisibility(View.VISIBLE);
         ...
         * 提示1
         */
        public void hintShow(String content) {
            AlertDialog.Builder builder = new AlertDialog.Builder(context, R.style.PromptDialogStyle);
            LayoutInflater inflater = LayoutInflater.from(context);
            View v = inflater.inflate(R.layout.hint_dialog, null);
            TextView tv_content = (TextView) v.findViewById(R.id.tv_content);
            tv_content.setText(content);
            TextView tv_sure = (TextView) v.findViewById(R.id.tv_queding);
