package common.feteing.commonutils.bannner;
...
import common.feteing.commonutils.bannner.transformer.BGAPageTransformer;
import common.feteing.commonutils.bannner.transformer.TransitionEffect;
...
public class BGABanner extends RelativeLayout implements BGAViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    public void hideContainerLl() {
        if(mPointRealContainerLl!=null){
            mPointRealContainerLl.setVisibility(View.GONE);
        }
        mPointRealContainerLl = null;
    }
