...
public class LogTest {
    ...
    private static String LOG_TAG = "feteING====>"; // 默认的tag
    ...
    public static void init(Context context) { // 在Application中初始化
        LOG_FILE_PATH = Environment.getExternalStorageDirectory().getPath() + File.separator + BaseApplication.instance.getPackageName();
        LOG_FILE_NAME = "Log";
    }
