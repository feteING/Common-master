...
public class ImageLoaderUtils {
    ...
    public static void displayRes(Context context, ImageView imageView, int resId) {
        Glide.with(context)
                .load(resId)
                .diskCacheStrategy(DiskCacheStrategy.ALL)
                .placeholder(placeholderId)
    ...
    public static void displayGray(Context context, ImageView imageView, String url) {
        Glide.with(context)
                .load(url)
                .diskCacheStrategy(DiskCacheStrategy.ALL)
                .error(errorId)
