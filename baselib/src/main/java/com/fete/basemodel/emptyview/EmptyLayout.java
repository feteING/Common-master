package com.fete.basemodel.emptyview;
...
/**
 * 空布局
 * private LinearLayout mLlCenter; //根布局
...
public class EmptyLayout {
    ...
    private static final int STATE_NONET = 0x04;


    private onEmptyListener mEmptyListener;
    private onErrorListener mErrorListener;
    private onNoNetListener mNoNetListener;
    ...
    private void invilidateNoNet() {
        if (mNoNetView == null) {
            mNoNetView = mInFlater.inflate(R.layout.empty_nonetlayout, null);
            mNoNetView.findViewById(R.id.btn_retry).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (mNoNetListener != null) {
                        mNoNetListener.onClickNoNet(v);
                    }
                }
            });
        }
        addViewInRoot(mNoNetView);
    }
    ...
    public void setmNoNetListener(onNoNetListener mNoNetListener) {
        this.mNoNetListener = mNoNetListener;
    }
