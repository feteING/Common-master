...
public class WelcomeActivity extends BaseActivity implements EasyPermissions.PermissionCallbacks {
    ...
    private Runnable mRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (DbService.isFirstLogin(WelcomeActivity.this)) {
                startThenKill(GuideActivity.class);
            } else {
//                startThenKill(LoginActivity.class);
                startThenKill(MainActivity.class);
            }
            WelcomeActivity.this.overridePendingTransition(R.anim.alpha_in, R.anim.my_alpha_action);
        }
    };
}
